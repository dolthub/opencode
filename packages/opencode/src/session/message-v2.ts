...
// System messages: chat-style output generated by opencode itself (slash
// commands, hooks, etc) rather than by a user or an LLM. They render in the
// TUI but are excluded from the context sent to the LLM (see prompt.ts).
...
const _Info = Schema.Union([User, Assistant, System]).annotate({
  discriminator: "role",
  identifier: "Message",
})
export const Info = Object.assign(_Info, {
  zod: zod(_Info) as unknown as z.ZodType<User | Assistant | System>,
})
